        ...
        <div class="fintech-card w-full space-y-4 p-5 lg:flex-1">
          ...
          <div class="grid grid-cols-2 gap-3">
            <div class="rounded-xl p-3" style="background: var(--color-surface-mid)">
              ...
              <p class="mt-1 text-xl font-bold text-white">{{ data.tarjeta.dia_corte }}</p>
            </div>
            <div class="rounded-xl p-3" style="background: var(--color-surface-mid)">
              <p class="text-[10px] uppercase tracking-wider text-slate-500">Día de pago</p>
              <p class="mt-1 text-xl font-bold text-white">{{ data.tarjeta.dia_pago }}</p>
            </div>
          </div>
          <div class="rounded-xl p-3" style="background: var(--color-surface-mid)">
            ...
            <table class="w-full min-w-[420px] text-sm">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="px-4 py-3 text-right font-mono text-slate-200">{{ formatCurrency(c.monto) }}</td>
        ...
        <div v-if="activeTab === 'tasa_cero'" class="mt-4 space-y-4">
          ...
          >
            <div class="flex items-start justify-between">
              ...
              <div class="text-right">
                <p class="font-mono text-base font-bold text-white">{{ formatCurrency(c.monto_total) }}</p>
            ...
            <div class="mt-4">
              <div class="mb-1.5 flex items-center justify-between text-xs">
                ...
                <span class="font-mono text-slate-300">{{ cuotasPagadas(c) }}/{{ c.total_cuotas }}</span>
              </div>
              ...
              <p class="mt-1.5 text-[10px] text-slate-500">
                Cuota mensual: <span class="font-mono text-slate-300">{{ formatCurrency(cuotaMonto(c)) }}</span>
              </p>
            </div>
          </div>
        </div>
