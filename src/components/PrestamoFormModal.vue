    ...
    <div v-if="modelValue" class="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <form class="mt-5 flex flex-col gap-4" @submit.prevent="submit">
          ...
          <!-- Resumen interés -->
          <div v-if="form.capital && form.tasa_display" class="rounded-lg px-4 py-3 text-xs" style="background:rgba(255,255,255,0.04)">
            <p class="text-slate-500">Interés mensual estimado:
